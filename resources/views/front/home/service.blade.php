<section class="diff-offer-wrapper">
    <div class="row diff-offer">
      <ul>
        <li class="col-md-6 col-xs-6 we-offer-cont">
          <h1><span>EDEN GROUP'S ENTREPRISE</span><br>vous souhaite la bienvenue</h1>
        </li>
        <li class="col-md-6 col-xs-6 we-offer-cont2">
          <p>Notre objectif, c'est de satisfaire nos clients dans tout les domaines. D'ou notre slogan <strong>Ensemble pour vous satisfaire</strong></p>
        </li>
      </ul>
    </div>
